...
export const DEFAULT_DEVOPS_APPS: DevopsApp[] = [
  { app: 'agentadmin', alias: 'agent控制台', group: 'JenkinsFrontweb' },
  { app: 'audit-view', alias: '视频审核页', group: 'JenkinsFrontweb' },
  { app: 'audit-web', alias: '总后台审核服务', group: 'JenkinsFrontweb' },
  ...
  { app: 'customerservice', alias: '客服系统', group: 'JenkinsFrontweb' },
  { app: 'data_admin', alias: '教培业务数据平台', group: 'JenkinsFrontweb' },
  { app: 'education', alias: '教培三分屏', group: 'JenkinsFrontweb' },
  { app: 'execution_mobile_com', alias: '约立拍移动官网', group: 'JenkinsFrontweb' },
  { app: 'execution_pc_com', alias: '约立拍pc官网', group: 'JenkinsFrontweb' },
  { app: 'GroupChat', alias: '星享App内嵌群聊', group: 'JenkinsFrontweb' },
  ...
  { app: 'kuta_admin', alias: '酷塔pc后台', group: 'JenkinsFrontweb' },
  ...
  { app: 'kuta_mobile', alias: '酷塔h5端', group: 'JenkinsFrontweb' },
  ...
  { app: 'livepage', alias: 'livepage', group: 'JenkinsFrontweb' },
  ...
  { app: 'sc-vzan-com', alias: '微赞竞价官网', group: 'JenkinsFrontweb' },
  { app: 'select_admin', alias: '选品平台PC版', group: 'JenkinsFrontweb' },
  { app: 'select_chain', alias: '微赞云选-存瑰宝', group: 'JenkinsFrontweb' },
  { app: 'select_com', alias: '选品官网', group: 'JenkinsFrontweb' },
  { app: 'select_mobile', alias: '选品平台H5版', group: 'JenkinsFrontweb' },
  { app: 'sell_vzan_os', alias: 'sell_vzan_os', group: 'JenkinsFrontweb' },
  { app: 'send_admin', alias: '超级群发后台', group: 'JenkinsFrontweb' },
  { app: 'shop_admin', alias: '聚店通管理后台', group: 'JenkinsFrontweb' },
  ...
  { app: 'store_admin', alias: 'PC版店长后台', group: 'JenkinsFrontweb' },
  { app: 'store_mobile', alias: '大健康-门店管理平台H5端', group: 'JenkinsFrontweb' },
  { app: 'supply_admin', alias: '供应商后台', group: 'JenkinsFrontweb' },
  ...
  { app: 'userlive', alias: '直播B端管理后台', group: 'JenkinsFrontweb' },
  ...
  { app: 'vzanlivemobile', alias: '新微信端h5', group: 'JenkinsFrontweb' },
  { app: 'vzanlivepc', alias: 'vzanlivepc', group: 'JenkinsFrontweb' },
  { app: 'vzanlive_weapp', alias: '微赞直播小程序', group: 'JenkinsFrontweb' },
  { app: 'weistream_admin_web', alias: '海外直播开放平台-管理后台', group: 'JenkinsFrontweb' },
  { app: 'weistream_com', alias: '海外直播开放平台-官网', group: 'JenkinsFrontweb' },
  { app: 'weistream_web', alias: '海外直播开放平台-流分发前端', group: 'JenkinsFrontweb' },
  ...
  { app: 'saas-scrm-admin-web', alias: 'saas-scrm-前端PC后台', group: 'JenkinsPAAS' },
  { app: 'saas-scrm-app-web', alias: 'saas-scrm-前端小程序', group: 'JenkinsPAAS' },
  { app: 'saas-scrm-cwx-web', alias: 'saas-scrm-前端企业微信', group: 'JenkinsPAAS' },
